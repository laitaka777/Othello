...
USES UnitSound,QDOffScreen,UnitOth0;
...
function CreateTempOffScreenWorld(var theRect : rect; var offScreen : GWorldPtr) : OSErr;
procedure KillTempOffscreenWorld(var wasPort : GWorldPtr);
...
USES Timer,UnitRapport,UnitCarbonisation;



var gThisGDevice : GDHandle	;

function CreateOffScreenPixMap(var theRect : rect; var offScreenGWorld : CGrafPtr);
var 
  oldDevice : GDHandle;
...
begin
  ...
  quickDrawErr := NewGWorld(offScreenGWorld, 0, theRect, NIL, NIL, 0 {0});
  ...
  EraseRect(MyGetPortBounds(offScreenGWorld));
