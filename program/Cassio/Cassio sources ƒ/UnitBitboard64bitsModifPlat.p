...
begin  {$UNUSED myBool,my_left,my_right,s,t}
     ...
     { flipping to the right of A1, without guard }
      ...
      if r <> 0 then
        begin
          ...
          number_of_flipped := 30 - __cntlzw(r);
        end;
  ...
  7) plus rapide de retourner vers la gauche au moins 2 pions a l'aide d'additions.
    ...
    { Flipping to the left of H1, without guard }
      ...
      my_left := MY and $0000003F;
			...
			if (r <> 0) then
			  begin
			    number_of_flipped := __cntlzw(my_left) - 25;
  ...
  *)
  ...
  tempsDeBase := nbTicks;
  WritelnStringAndNumDansRapport('methode 0 : nbTicks = ', nbTicks);
  WritelnStringAndNumDansRapport('temps de retournements : nbTicks = ',nbTicks- tempsDeBase);
  {WritelnStringAndNumDansRapport('flipped = ', flipped);
  {WritelnStringAndNumDansRapport('flipped = ', flipped);
  WritelnStringAndNumDansRapport('number_of_flipped = ', number_of_flipped);}
  WritelnStringAndNumDansRapport('accu_flipped = ',accu_flipped);
  WritelnStringAndNumDansRapport('total_flipped = ',total_flipped);
  WritelnStringAndNumDansRapport('total_opp = ',total_opp);
  WritelnDansRapport('');
  dejaEcrit := false;
  ...
  WritelnStringAndNumDansRapport('methode 1 : nbTicks = ', nbTicks);
  WritelnStringAndNumDansRapport('temps de retournements : nbTicks = ',nbTicks- tempsDeBase);
  {WritelnStringAndNumDansRapport('flipped = ', flipped);
  WritelnStringAndNumDansRapport('number_of_flipped = ', number_of_flipped);}
  WritelnStringAndNumDansRapport('accu_flipped = ',accu_flipped);
  ...
  WritelnStringAndNumDansRapport('methode 2 : nbTicks = ', nbTicks);
  WritelnStringAndNumDansRapport('temps de retournements : nbTicks = ',nbTicks- tempsDeBase);
  {WritelnStringAndNumDansRapport('flipped = ', flipped);
  WritelnStringAndNumDansRapport('number_of_flipped = ', number_of_flipped);}
  WritelnStringAndNumDansRapport('accu_flipped = ',accu_flipped);
  ...
  WritelnStringAndNumDansRapport('methode 3 : nbTicks = ', nbTicks);
  WritelnStringAndNumDansRapport('temps de retournements : nbTicks = ',nbTicks- tempsDeBase);
  {WritelnStringAndNumDansRapport('flipped = ', flipped);
  WritelnStringAndNumDansRapport('number_of_flipped = ', number_of_flipped);}
  WritelnStringAndNumDansRapport('accu_flipped = ',accu_flipped);
