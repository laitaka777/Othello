...
function PeutJouerIci(couleur,a : SInt32; var plat : plateauOthello) : boolean;
function DoitPasser(coul : SInt32; var plat : plateauOthello; var jouable : plBool) : boolean;
...
function ModifPlatLongint(a,coul : SInt32; var jeu : plateauOthello; var jouable : plBool; var nbbl,nbno : SInt32; var front : InfoFrontRec) : boolean;
...
function EstLaPositionStandardDeDepart(var plat : plateauOthello) : boolean;
procedure CarteMove(coul : SInt32; var plat : plateauOthello; var carte : plBool; var mobilite : SInt32);
function NbreDirectionsJouables(couleur,a : SInt32; var plat : plateauOthello) : SInt32;
function PeutJouerIciUnidirectionnel(couleur,a : SInt32; var plat : plateauOthello; var frontiere : InfoFrontRec; var deltaFrontiere : SInt32) : SInt32;
function PeutJouerIciBonCoup(couleur,a : SInt32; var plat : plateauOthello; var frontiere : InfoFrontRec; var coupTranquille : boolean) : boolean;
function ValeurUnidirectionnelleDuCoup(couleur,a : SInt32; var plat : plateauOthello) : SInt32;
function ValeurSemiTranquilleDuCoup(couleur,a : SInt32; var plat : plateauOthello; var frontiere : InfoFrontRec; var coupTranquille : boolean; var deltaFrontiere : SInt32) : SInt32;
function mobiliteUnidirectionnelle(coul : SInt32; var plat : plateauOthello; var jouable : plBool; var frontiere : InfoFrontRec) : SInt32;
function mobiliteUnidirectionnelleMinimisante(coul : SInt32; var plat : plateauOthello; var jouable : plBool) : SInt32;
function mobiliteUnidirectionnelleAvecCasesC(coul : SInt32; var plat : plateauOthello; var jouable : plBool; var frontiere : InfoFrontRec) : SInt32;
function mobiliteUnidirectionnelleMinimisanteAvecCasesC(coul : SInt32; var plat : plateauOthello; var jouable : plBool; var frontiere : InfoFrontRec) : SInt32;
function mobiliteBonsCoups(coul : SInt32; var plat : plateauOthello; var jouable : plBool; var frontiere : InfoFrontRec; var nbCoupsTranquilles : SInt32) : SInt32;
function MobiliteSemiTranquilleAvecCasesC(coul : SInt32; var plat : plateauOthello; var jouable : plBool; var frontiere : InfoFrontRec; var ListeDesCoupsTranquilles : ListeDeCases;seuil_coupure : SInt32) : SInt32;
...
function CalculeMobilitePlatSeulement(var plat : plateauOthello;coul : SInt32) : SInt32;
...
procedure CarteJouable(var plat : plateauOthello; var carte : plBool);
procedure CarteVide(var plat : plateauOthello; var carte : plateauOthello);
procedure CarteFrontiere(var plat : plateauOthello; var front : InfoFrontRec);
...
function PasDeBordDeCinqAttaque(couleur : SInt32; var front : InfoFrontRec; var plat : plateauOthello) : boolean;
function BordDeCinqUrgent(var plat : plateauOthello; var front : InfoFrontRec) : boolean;
function EstTurbulent(var pl : plateauOthello;couleur,nbBlancs,nbNoirs : SInt32; var front : InfoFrontRec; var caseCritiqueTurbulence : SInt32) : boolean;
...
procedure CalculePositionFinale(ligne:str120; var plat : plateauOthello; var ligneLegale : boolean; var nbCoupsLegaux : SInt32);
procedure CoupAuHazard(CouleurChoix : SInt32;jeu : plateauOthello;empl : plBool; var ChoixX,valeur : SInt32);
function ModifPlat(a,coul : SInt32; var jeu : plateauOthello; var jouable : plBool; var nbbl,nbno : SInt32; var front : InfoFrontRec) : boolean;
function nbBordDeCinqTransformablesPourBlanc(var plat : plateauOthello; var front : InfoFrontRec) : SInt32;
function BonsBordsDeCinqNoirs(var plat : plateauOthello; var front : InfoFrontRec) : SInt32;
function BonsBordsDeCinqBlancs(var plat : plateauOthello; var front : InfoFrontRec) : SInt32;
function TrousDeTroisBlancsHorribles(var plat : plateauOthello) : SInt32;
function TrousDeTroisNoirsHorribles(var plat : plateauOthello) : SInt32;
...
function LibertesNoiresSurCasesA(var plat : plateauOthello; var front : InfoFrontRec) : SInt32;
function LibertesBlanchesSurCasesA(var plat : plateauOthello; var front : InfoFrontRec) : SInt32;
...
function ArnaqueSurBordDeCinqBlanc(var pl : plateauOthello; var front : InfoFrontRec) : SInt32;
function ArnaqueSurBordDeCinqNoir(var pl : plateauOthello; var front : InfoFrontRec) : SInt32;
function NotationBordsOpposesPourNoir(var pl : plateauOthello) : SInt32;
function BordDeSixNoirAvecPrebordHomogene(var pl : plateauOthello; var front : InfoFrontRec) : SInt32;
function BordDeSixBlancAvecPrebordHomogene(var pl : plateauOthello; var front : InfoFrontRec) : SInt32;
...
USES UnitOth2,UnitRapport,UnitUtilitaires,UnitScannerOthellistique,UnitMacExtras;
...
begin   
  {
  WriteStringAndNumAt('PeutJouerIci   ',TickCount(),10,10);
  WriteStringAndNumAt('PeutJouerIci   ',TickCount(),10,20);
  WriteStringAndNumAt('a=',a,10,30);
  if plat[a] <> pionVide then 
    begin
      WriteStringAndNumAt('plat[a] <> 0 !!!',a,30,30);
      SysBeep(0);
      AttendFrappeClavier;
      sysbreak;
    end;
  WriteStringAndNumAt('                  ',a,30,30);
  WriteStringAndNumAt('dirPriseDeb[a]=',dirPriseDeb[a],10,40);
  WriteStringAndNumAt('dirPriseFin[a]=',dirPriseFin[a],10,50);
  }
  ...
  if effetspecial2 & (nbDirectionsRetournement=1) & (nbDirectionsNonTranquilles>=1)
   then
    begin
      ...
      WriteStringAndNumAt('nb vides de '+CoupEnStringEnMajuscules(a)+' = ',frontiere.nbVide[a],130,30);
...
begin
  ...
  nbCoupsLegaux := 0;
  ok := true;
  for i := 1 to Length(ligne) div 2 do
    begin
