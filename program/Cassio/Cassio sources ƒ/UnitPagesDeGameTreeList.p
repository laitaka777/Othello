...
const nbPagesDeGameTreeList = 10000;
...
begin
  for i := 1 to nbPagesDeGameTreeList do
	...
	if PeutCreerNouvellePageGameTreeList() then;
...
begin
  ...
  WritelnStringAndNumDansRapport('soldeCreationGameTreeList=',soldeCreationGameTreeList);
  SysBeep(0);
  AttendFrappeClavier;
  }
...
var n,i,k : SInt32;
begin
  if dernierePageGameTreeListCree<=0 then
    begin
...
begin
  ...
  {WritelnStringAndNumDansRapport('appel de DisposeGameTreeListPaginee pour @',SInt32(L));}
