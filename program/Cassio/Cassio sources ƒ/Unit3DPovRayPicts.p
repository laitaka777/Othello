...
USES QDOffscreen,UnitOffScreenGraphics,UnitFichiersPICT,UnitFichierPhotos,UnitRapport,UnitCouleur,
     UnitTroisiemeDimension,UnitBufferedPICT,UnitAfficheArbreDeJeuCourant,UnitArbreDeJeuCourant,
     UnitOth1,SNStrings;
...
var nomDansMenu,path : str255;
    ...
    procedure ExitIfError(whichError : OSErr;fonctionAppelante : str255);
    begin
    ...
    begin
      ...
      case couleur of
        kCaseDevantEtreRedessinee :
		      begin
		        case jeuCourant[whichSquare] of
		          pionBlanc,pionNoir: 
		            begin
		              DumpDiscToGWorld(whichSquare,jeuCourant[whichSquare],targetGWolrd);
		          ...
		          otherwise 
		            begin
		              ...
		              DessineAutresInfosSurCasesAideDebutant([whichSquare]);
		            end;
		        end;
		      end;
        pionNoir : 
