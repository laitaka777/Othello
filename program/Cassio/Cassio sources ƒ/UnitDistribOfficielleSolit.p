...
USES UnitSolitairesNouveauFormat;
...
USES UnitNouveauFormat,UnitRapport,Sound,SNStrings;
...
begin
  ...
  if (nbreCasesVides>0) & (nbreCasesVides<=60) then
    begin
		  ...
		  SetFileCreatorFichierTexte(fichierSolitaires,'SNX4');
		  SetFileTypeFichierTexte(fichierSolitaires,'PZZL');
      ...
      begin
        ...
        if (nbSolitaires <> statsPourCeFichier.nbSolitairesCetteProf[nbCasesVides]) then
          begin
            ...
            WritelnStringAndNumDansRapport('nbSolitaires = ',nbSolitaires);
            WritelnStringAndNumDansRapport('statsPourCeFichier.nbSolitairesCetteProf[nbCasesVides] = ',statsPourCeFichier.nbSolitairesCetteProf[nbCasesVides]);
            WritelnDansRapport('');
          end;
        ...
        with verifSolitaire do
          begin
	          WritelnStringAndNumDansRapport('annee=',annee);
					  WritelnStringAndNumDansRapport('nroTournoi=',nroTournoi);
					  WritelnStringAndNumDansRapport('nroJoueurNoir=',nroJoueurNoir);
					  WritelnStringAndNumDansRapport('nroJoueurBlanc=',nroJoueurBlanc);
					  WritelnPositionEtTraitDansRapport(PackedOthelloPositionToPlOth(position),traitSolitaire);
					  WritelnStringAndNumDansRapport('nbVides=',nbVides);
