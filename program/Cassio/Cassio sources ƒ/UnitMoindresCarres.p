...
uses UnitOth0,UnitAlgebreLineaire;



procedure DoRegressionLineaireCoeffsCassio(ApresQuelCoup : SInt16);
procedure WritelnVecteurEvaluationDansRapport(nom : str255;vecteurEvals:VecteurReels;nbChiffres : SInt16);
...
USES UnitEvaluation,UnitAccesStructuresNouvFormat,UnitUtilitaires,UnitStrategie,UnitRapport,
     UnitNouveauFormat,UnitSuperviseur,SNStrings;
...
begin
  ...
  WriteLNStringAndNumDansRapport('mfit=',mfit);
  WriteLNStringAndNumDansRapport('ma=',ma);
  ...
  for i := 1 to nbData do
    begin
      ...
      if partieOK then
        begin
          if (i mod 1000)=0 then WritelnStringandNumDansRapport('',i);
