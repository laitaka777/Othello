UNIT UnitLongintScrollerPourListe;
...
procedure CalculeControlLongintMaximum(nbreLignesFntreListe : SInt32);
...
USES UnitOth1,UnitListe,UnitRapport,UnitServicesDialogs,FixMath,UnitCarbonisation;
