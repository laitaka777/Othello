...
USES UnitVariablesGlobalesFinale;
...
USES UnitUtilitaires,UnitServicesDialogs,UnitOth2,UnitScannerOthellistique,UnitRapport,UnitGestionDuTemps,UnitUtilitairesFinale;
...
begin
  if (whichSquare<11) | (whichSquare>88) then
    begin
      SysBeep(0);
      WritelnStringAndNumDansRapport('HORREUR !! dans EnleverDeLaListeChaineeDesCasesVides, whichSquare=',whichSquare);
      AlerteSimple('Gros problème dans EnleverDeLaListeChaineeDesCasesVides');
      LanceInterruption(interruptionSimple,'EnleverDeLaListeChaineeDesCasesVides (1)');
  ...
  if celluleDansListeChaineeCasesVides = NIL then
    begin
      SysBeep(0);
      WritelnDansRapport('HORREUR !! celluleDansListeChaineeCasesVides = NIL dans EnleverDeLaListeChaineeDesCasesVides');
      AlerteSimple('Enorme problème dans EnleverDeLaListeChaineeDesCasesVides');
      LanceInterruption(interruptionSimple,'EnleverDeLaListeChaineeDesCasesVides (2)');
      exit(EnleverDeLaListeChaineeDesCasesVides);
    end;
...
begin
  if (whichSquare<11) | (whichSquare>88) then
    begin
      SysBeep(0);
      WritelnStringAndNumDansRapport('HORREUR !! dans RemettreDansLaListeChaineeDesCasesVides, whichSquare=',whichSquare);
      AlerteSimple('Gros problème dans RemettreDansLaListeChaineeDesCasesVides');
      LanceInterruption(interruptionSimple,'RemettreDansLaListeChaineeDesCasesVides (1)');
  ...
  if celluleDansListeChaineeCasesVides = NIL then
    begin
      SysBeep(0);
      WritelnDansRapport('HORREUR !! celluleDansListeChaineeCasesVides = NIL dans RemettreDansLaListeChaineeDesCasesVides');
      AlerteSimple('Enorme problème dans RemettreDansLaListeChaineeDesCasesVides');
      LanceInterruption(interruptionSimple,'RemettreDansLaListeChaineeDesCasesVides (2)');
      exit(RemettreDansLaListeChaineeDesCasesVides);
    end;
      ...
      begin
        ...
        if (square>=11) & (square<=88)
          then
            ...
            begin
			        if longueur=1
			          then WriteStringAndNumDansRapport('[',square)
			          else WriteStringAndNumDansRapport(',',square);
			      end;
...
begin
  ...
  repeat 
    ...
    WriteStringAndNumDansRapport('  next=',SInt32(@celluleDansListeChainee1^.next));
    WriteStringAndNumDansRapport('  previous=',SInt32(@celluleDansListeChainee1^.previous));
    ...
    WriteStringAndNumDansRapport('  next=',SInt32(@celluleDansListeChainee2^.next));
    WriteStringAndNumDansRapport('  previous=',SInt32(@celluleDansListeChainee2^.previous));
