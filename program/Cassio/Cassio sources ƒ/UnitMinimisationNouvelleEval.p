UNIT UnitMinimisationNouvelleEval;
...
USES UnitChi2NouvelleEval,UnitMinimisation;

procedure LineMinimisationChi2(var p,xi : VecteurNouvelleEval;valeurChi2PourP : TypeReel; var fret : TypeReel);
procedure ConjugateGradientChi2(var p : VecteurNouvelleEval;ftol : TypeReel; var iter : SInt32; var fret : TypeReel;avecRabotagePatternsRares : boolean);
...
USES UnitUtilitaires,UnitServicesDialogs,UnitRapport,SNStrings,UnitGestionDuTemps;
...
procedure InitialiseFonctionLigneChi2(var p,xi : VecteurNouvelleEval);
begin
...
procedure ConjugateGradientChi2(var whichEval : VecteurNouvelleEval;ftol : TypeReel; var iter : SInt32; var fret : TypeReel;avecRabotagePatternsRares : boolean);
const 
  itmax = 100;
  eps = 1.0e-10;
label finNormale;
  ...
  *)
  ...
  if erreurES=NoErr then
     begin
       ...
       if erreurES<>NoErr then WritelnStringAndNumDansRapport(' => erreurES=',erreurES);
