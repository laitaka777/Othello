...
procedure WriteSortedSetDansRapport(const nom : str255;S:SortedSet;avecCardinal : boolean);
procedure WritelnSortedSetDansRapport(const nom : str255;S:SortedSet;avecCardinal : boolean);
