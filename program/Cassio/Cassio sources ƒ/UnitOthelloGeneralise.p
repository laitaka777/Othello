...
function SameBigOthelloRec(var pos1,pos2 : BigOthelloRec) : boolean;
function BigOthelloEstVide(var position : BigOthelloRec) : boolean;
...
{conversions}
function BigOthelloEnChaine(var position : BigOthelloRec) : str255;
...
USES UnitRapport,UnitOth2,SNStrings,UnitServicesMemoire,Sound;
