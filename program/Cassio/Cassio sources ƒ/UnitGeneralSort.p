...
USES UnitSound,UnitRapport,UnitMacExtras,UnitOth1,UnitServicesDialogs;


  
{ Attention ! La routine d'ordre doit renvoyer vrai pour des ŽlŽments egaux, sinon QuickSort ne s'arrete pas}
procedure GeneralQuickSort(lo,up : SInt32; lecture : LectureTableauProc; affectation : AffectationProc; ordre : OrdreProc);
const nstack=100;
      m=7;
