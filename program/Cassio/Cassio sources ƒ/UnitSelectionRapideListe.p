...
function GetDerniereChaineSelectionRapide() : str255;
function GetDernierGenreSelectionRapide():typeSelectionRapide;
procedure SetDerniereChaineSelectionRapide(s : str255);
procedure SetDernierGenreSelectionRapide(genre:typeSelectionRapide);


{gestion des demandes de selection rapide}
procedure TraiteSelectionRapideDeListe(genre:typeSelectionRapide;chaineCherchee : str255);
...
USES UnitListe,UnitCriteres,UnitUtilitaires,UnitCriteres,UnitAccesStructuresNouvFormat,MyStrings,
     UnitOth1,SNStrings;
  ...
  historiqueFrappeSelectionRapide:
      record
        ...
        liste : array [1..kTailleHistorique] of 
				...
				derniereChaineConstruite : str255;
		      ...
		      case genre of
		        kSelRapideTournoi:
		          begin
		            ...
		            if (chaineCherchee[Length(chaineCherchee)] = '=') then
		              begin
		                chaineCherchee := TPCopy(chaineCherchee,1,Length(chaineCherchee)-1);
		                chaineCherchee := Complemente(complementationTournoi,chaineCherchee,longueur);
		              end;
		        ...
		        kSelRapideNoir:
		          begin
		            ...
		            if (chaineCherchee[Length(chaineCherchee)] = '=') then
		              begin
		                chaineCherchee := TPCopy(chaineCherchee,1,Length(chaineCherchee)-1);
		                chaineCherchee := Complemente(complementationJoueurNoir,chaineCherchee,longueur);
		              end;
		        ...
		        kSelRapideBlanc:
		          begin
		            ...
		            if (chaineCherchee[Length(chaineCherchee)] = '=') then
		              begin
		                chaineCherchee := TPCopy(chaineCherchee,1,Length(chaineCherchee)-1);
		                chaineCherchee := Complemente(complementationJoueurBlanc,chaineCherchee,longueur);
		              end;
