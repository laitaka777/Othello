...
USES UnitAccesStructuresGraphe; 
...
function CoupEstDansListe(var fichier : Graphe; coupCherche : byte; var liste : ListeDeCellules; var numCellule : SInt32) : boolean;
function CoupEstDansListeDeCellulesEtDeCoups(coupCherche : byte; var liste:listeDeCellulesEtDeCoups; var numCellule : SInt32) : boolean;
...
function MaxEsperanceDeGainDansListe(var fichier : Graphe; var maListe : ListeDeCellules;couleur : SInt16) : extended;
function MinEsperanceDeGainDansListe(var fichier : Graphe; var maListe : ListeDeCellules;couleur : SInt16) : extended;
...
function PourcentageDeGainParmilesFils(var fichier : Graphe;numCellule : SInt32) : extended;
...
USES UnitAccesStructuresNouvFormat,UnitRapport,UnitMacExtras,UnitScannerOthellistique,
     UnitEntreesSortiesGraphe,UnitPositionEtTrait,UnitPileEtFile,UnitDefinitionsApprentissage;
...
begin
  ...
  {
  WritelnStringAndNumDansRapport('adresseListe1=',adresseListe1);
  WritelnStringAndNumDansRapport('adresseListe2=',adresseListe2);
  WritelnStringAndNumDansRapport('adresseResult=',adresseResult);
  }
...
begin  {$UNUSED myLongintPtr}
  (*
  WritelnStringAndNumDansRapport('sizeof(typesCherches)=',Sizeof(typesCherches));
  myLongintPtr := @typesCherches;
  WritelnStringAndNumDansRapport('SInt32(typesCherches)=',myLongintPtr^);
  WriteDansRapport('typesCherches={');
  for k := kPasDansT to kPerteAbsolue do
    if k in typesCherches then
      WriteStringAndNumDansRapport(' ',k);
  WritelnDansRapport(' }');
  *)
