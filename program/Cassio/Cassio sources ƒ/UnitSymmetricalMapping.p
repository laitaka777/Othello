...
var nouveauEdge2X,nouveauCorner13 : SInt32;
...
USES UnitOth0,UnitNewGeneral,UnitRapport;

type tableSymetriqueLignesPtr = ^array[0..8,-3281..3281] of SInt32;
     tableSymetriqueEdge2XPtr = ^array[-29525..29525] of SInt32;
     tableSymetrique13CornerPtr = ^array[-797162..797162] of SInt32;
     

const kTailleBufferMapping = 16;
      kSymetrisationNonEncoreCalculee = -130000000;  {ou n'importe quelle valeur > 3^13}

var DernierIndexDansBufferMapping : array[0..kTailleMaximumPattern] of SInt16;
...
begin
  ...
  WritelnStringAndNumDansRapport('entrŽe dans AlloueMemoireSymmetricalMapping, tailleDisponible=',tailleDisponible);
  if tailleDisponible>8000000
    then
      begin
        ...
        grow := 0;
        tailleDisponible := MaxMem(grow)-TailleReserveePourLesSegments;
        WritelnStringAndNumDansRapport('sortie de AlloueMemoireSymmetricalMapping, tailleDisponible=',tailleDisponible);
      end;
