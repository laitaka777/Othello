...
USES UnitBigVectors,UnitNewGeneral;

type VecteurNouvelleEval =
       record
         Edges2X : array[0..kNbMaxGameStage] of PointMultidimensionnel;
         Pattern : array[0..kNbPatternsDansEval,0..kNbMaxGameStage] of PointMultidimensionnel;
...
procedure AlloueVecteurEval(var vecteur : VecteurNouvelleEval);
procedure DisposeVecteurEval(var vecteur : VecteurNouvelleEval);

function VecteurEvalEstVide(var vecteur : VecteurNouvelleEval) : boolean;
procedure AnnihileVecteurEval(var vecteur : VecteurNouvelleEval);
procedure CopierPointeursVecteursEval(var source,dest : VecteurNouvelleEval);
procedure AnnuleVecteurEval(var vecteur : VecteurNouvelleEval);


procedure SetValeurDansVecteurEval(var p : VecteurNouvelleEval;valeur : TypeReel);
procedure IdentiteVecteurEval(var p : VecteurNouvelleEval);
procedure HomothetieVecteurEval(var p,result : VecteurNouvelleEval;scale : TypeReel);
procedure NegationVecteurEval(var p,result : VecteurNouvelleEval);
procedure ValeurAbsolueVecteurEval(var p,result : VecteurNouvelleEval);
procedure AddVecteurEval(var p1,p2,resultat : VecteurNouvelleEval);
procedure DiffVecteurEval(var p1,p2,resultat : VecteurNouvelleEval);
procedure DivisionVecteurEval(var p1,p2,resultat : VecteurNouvelleEval);
procedure DivisionBorneeVecteurEval(var p1,p2,resultat : VecteurNouvelleEval;borne : TypeReel);
procedure CopierVecteurEval(var source,dest : VecteurNouvelleEval);
procedure CopierOpposeVecteurEval(var source,dest : VecteurNouvelleEval);
procedure CombinaisonLineaireVecteurEval(var p1,p2 : VecteurNouvelleEval;lambda1,lambda2 : TypeReel; var resultat : VecteurNouvelleEval);
function ProduitScalaireVecteurEval(var p1,p2 : VecteurNouvelleEval) : TypeReel;
function CombinaisonScalaireVecteurEval(var p1,p2,p3 : VecteurNouvelleEval;lambda1,lambda2 : TypeReel) : TypeReel;



function EcritEvalDansFichierTexte(var fic : FichierTEXT; var v : VecteurNouvelleEval) : OSErr;
function LitEvalDansFichierTexte(var fic : FichierTEXT; var v : VecteurNouvelleEval) : OSErr;
function EcritVecteurEvaluationSurLeDisque(nomFichier : str255;vRefNum : SInt16; var whichEval : VecteurNouvelleEval) : OSErr;
function LitVecteurEvaluationSurLeDisque(nomFichier : str255; var whichEval : VecteurNouvelleEval) : OSErr;


procedure MetCoeffsMobiliteEtFrontiereConstantsDansEvaluation(var whichEval : VecteurNouvelleEval);
procedure SmoothThisEvaluation(var whichEval : VecteurNouvelleEval; var whichOccurences : VecteurNouvelleEval);
procedure AbaisseEvalPatternsRares(var whichEval : VecteurNouvelleEval; var whichOccurences : VecteurNouvelleEval;valeurMaxPattern,RapportMaxValeurSurOccurence : TypeReel);
procedure AbaisseGradientPatternsRares(var whichEval,whichGradient,whichOccurences : VecteurNouvelleEval;valeurMaxPattern,RapportMaxValeurSurOccurence : TypeReel);
procedure CalculeEvalPatternsInexistantParEchangeCouleur(var whichEval : VecteurNouvelleEval; var whichOccurences : VecteurNouvelleEval);
...
USES UnitNouvelleEval,UnitRapport,SNStrings;
...
begin
  ...
  grow := 0;
  tailleDisponible := MaxMem(grow)-TailleReserveePourLesSegments;
  WritelnStringAndNumDansRapport('tailleDisponible=',tailleDisponible);
    ...
    begin
		  ...
		  for stage := 0 to kNbMaxGameStage do
		    if AllocatePointMultidimensionnel(taille,vecteur.Edges2X[stage]) 
		      ...
		      else WritelnStringAndNumDansRapport('impossible d''allouer la table bord + 2X pour stage=',stage);
		  ...
		  for stage := 0 to kNbMaxGameStage do
		    begin
		      ...
		      if AllocatePointMultidimensionnel(taille,vecteur.Pattern[kAdresseColonne1,stage]) 
		        ...
		        else WritelnStringAndNumDansRapport('impossible d''allouer la table de bord pour stage=',stage);
		      ...
		      if AllocatePointMultidimensionnel(taille,vecteur.Pattern[kAdresseColonne2,stage]) 
		        ...
		        else WritelnStringAndNumDansRapport('impossible d''allouer la table de prebord pour stage=',stage);
		      ...
		      if AllocatePointMultidimensionnel(taille,vecteur.Pattern[kAdresseColonne3,stage]) 
		        ...
		        else WritelnStringAndNumDansRapport('impossible d''allouer la table de ligne3 pour stage=',stage);
		      ...
		      if AllocatePointMultidimensionnel(taille,vecteur.Pattern[kAdresseColonne4,stage]) 
		        ...
		        else WritelnStringAndNumDansRapport('impossible d''allouer la table de ligne4 pour stage=',stage);
		      ...
		      for whichDiago := kAdresseDiagonaleA4E8 to kAdresseDiagonaleA1H8 do
		        begin
		          ...
		          if AllocatePointMultidimensionnel(taille,vecteur.Pattern[whichDiago,stage])
		            ...
		            else WritelnStringAndNumDansRapport('impossible d''allouer la table de diago('+NumEnString(longueurDiago)+') pour stage=',stage);
...
begin
  for stage := 0 to kNbMaxGameStage do
    begin
      ...
      for k := 0 to kNbPatternsDansEval do
   ...
   for i := 1 to nbTablesDifferentes do
     with table[i] do
       if sorte=kEdge2X then
         ...
         begin
           if (vecteur.Pattern[nroPattern,stage] <> NIL) then
             AnnulePointMultidimensionnel(vecteur.Pattern[nroPattern,stage]);
         end;
   ...
   for i := 1 to nbTablesDifferentes do
     with table[i] do
       if sorte=kEdge2X then
         ...
         begin
           if (p.Pattern[nroPattern,stage] <> NIL) then
             SetValeurDansPointMultidimensionnel(p.Pattern[nroPattern,stage],valeur);
         end;
   ...
   for i := 1 to nbTablesDifferentes do
     with table[i] do
       if sorte=kEdge2X then
         ...
         begin
           if (p.Pattern[nroPattern,stage] <> NIL) then
             IdentitePointMultidimensionnel(p.Pattern[nroPattern,stage]);
         end;
   ...
   for i := 1 to nbTablesDifferentes do
     with table[i] do
       if sorte=kEdge2X then
         ...
         begin
           if (p.Pattern[nroPattern,stage] <> NIL) then
             HomothetiePointMultidimensionnel(p.Pattern[nroPattern,stage],result.Pattern[nroPattern,stage],scale);
         end;
   ...
   for i := 1 to nbTablesDifferentes do
     with table[i] do
       if sorte=kEdge2X then
         ...
         begin
           if (p.Pattern[nroPattern,stage] <> NIL) then
             NegationPointMultidimensionnel(p.Pattern[nroPattern,stage],result.Pattern[nroPattern,stage]);
         end;
   ...
   for i := 1 to nbTablesDifferentes do
     with table[i] do
       if sorte=kEdge2X then
         ...
         begin
           if (p.Pattern[nroPattern,stage] <> NIL) then
             ValeurAbsoluePointMultidimensionnel(p.Pattern[nroPattern,stage],result.Pattern[nroPattern,stage]);
         end;
   ...
   for i := 1 to nbTablesDifferentes do
     with table[i] do
       if sorte=kEdge2X then
         ...
         begin
           if (p1.Pattern[nroPattern,stage] <> NIL) then
             AddPointMultidimensionnel(p1.Pattern[nroPattern,stage],p2.Pattern[nroPattern,stage],resultat.Pattern[nroPattern,stage]);
         end;
   ...
   for i := 1 to nbTablesDifferentes do
     with table[i] do
       if sorte=kEdge2X then
         ...
         begin
           if (p1.Pattern[nroPattern,stage] <> NIL) then
             DiffPointMultidimensionnel(p1.Pattern[nroPattern,stage],p2.Pattern[nroPattern,stage],resultat.Pattern[nroPattern,stage]);
         end;
   ...
   for i := 1 to nbTablesDifferentes do
     with table[i] do
       if sorte=kEdge2X then
         ...
         begin
           if (p1.Pattern[nroPattern,stage] <> NIL) then
             DivisionPointMultidimensionnel(p1.Pattern[nroPattern,stage],p2.Pattern[nroPattern,stage],resultat.Pattern[nroPattern,stage]);
         end;
   ...
   for i := 1 to nbTablesDifferentes do
     with table[i] do
       if sorte=kEdge2X then
         ...
         begin
           if (p1.Pattern[nroPattern,stage] <> NIL) then
             DivisionBorneePointMultidimensionnel(p1.Pattern[nroPattern,stage],p2.Pattern[nroPattern,stage],resultat.Pattern[nroPattern,stage],borne);
         end;
   ...
   for i := 1 to nbTablesDifferentes do
     with table[i] do
       if sorte=kEdge2X then
         ...
         begin
           if (p1.Pattern[nroPattern,stage] <> NIL) then
             CombinaisonLineairePointMultidimensionnel(p1.Pattern[nroPattern,stage],p2.Pattern[nroPattern,stage],lambda1,lambda2,resultat.Pattern[nroPattern,stage]);
         end;
   ...
   for i := 1 to nbTablesDifferentes do
     with table[i] do
       if sorte=kEdge2X then
         ...
         begin
           if (source.Pattern[nroPattern,stage] <> NIL) then
             CopierPointMultidimensionnel(source.Pattern[nroPattern,stage],dest.Pattern[nroPattern,stage]);
         end;
   ...
   for i := 1 to nbTablesDifferentes do
     with table[i] do
       if sorte=kEdge2X then
         ...
         begin
           if (source.Pattern[nroPattern,stage] <> NIL) then
             CopierOpposePointMultidimensionnel(source.Pattern[nroPattern,stage],dest.Pattern[nroPattern,stage]);
         end;
   ...
   for i := 1 to nbTablesDifferentes do
     with table[i] do
       if sorte=kEdge2X then
         ...
         begin
           if (p1.Pattern[nroPattern,stage] <> NIL) then
             somme := somme+ProduitScalairePointMultidimensionnel(p1.Pattern[nroPattern,stage],p2.Pattern[nroPattern,stage]);
         end;
   ...
   for i := 1 to nbTablesDifferentes do
     with table[i] do
       if sorte=kEdge2X then
         ...
         begin
           if (p1.Pattern[nroPattern,stage] <> NIL) then
             somme := somme+CombinaisonScalairePointMultidimensionnel(p1.Pattern[nroPattern,stage],p2.Pattern[nroPattern,stage],p3.Pattern[nroPattern,stage],lambda1,lambda2);
         end;
...
begin
  ...
  SetFileCreatorFichierTexte(fichierEval,'SNX4');
  SetFileTypeFichierTexte(fichierEval,'EVAL');
       ...
       if sorte=kEdge2X 
         then
		               ...
		               begin
		                 ...
		                 for j := kNbMaxGameStage downto stage+1 do
		                  ...
		                  { begin
		                     ...
		                     WritelnStringAndNumDansRapport('stage=',stage);
		                     WritelnDansRapport('');
		                   end;}
           ...
           begin
            for k := 1 to puiss3[longueurPattern+1] do
              begin
		             if whichOccurences.Pattern[nroPattern,stage]^[k]<=0.05 then
		               begin
		                 stageMin := 0;
		                 debut := 0.0;
		                 for j := 0 to stage-1 do
		                   if whichOccurences.Pattern[nroPattern,j]^[k]>0.1 then
		                     begin
		                       stageMin := j;
		                       debut := whichEval.Pattern[nroPattern,j]^[k];
		                     end;
		                 ...
		                 for j := kNbMaxGameStage downto stage+1 do
		                   if whichOccurences.Pattern[nroPattern,j]^[k]>0.1 then
		                     begin
		                       stageMax := j;
		                       fin := whichEval.Pattern[nroPattern,j]^[k];
		                     end;
		                 
		                 whichEval.Pattern[nroPattern,stage]^[k] := debut+(fin-debut)*(stage-stageMin)/(stageMax-stageMin);
		               end;
		           end;
           end;
end;
       ...
       if sorte=kEdge2X 
         then
           ...
           begin
            for k := 1 to puiss3[longueurPattern+1] do
              begin
                occ := RoundToL(whichOccurences.Pattern[nroPattern,stage]^[k]);
                valeur := whichEval.Pattern[nroPattern,stage]^[k];
                ...
                whichEval.Pattern[nroPattern,stage]^[k] := valeur;
		           end;
           end;
end;
           ...
           begin
            for k := 1 to puiss3[longueurPattern+1] do
              begin
                occ := RoundToL(whichOccurences.Pattern[nroPattern,stage]^[k]);
                valeur := whichEval.Pattern[nroPattern,stage]^[k];
                valeurGradient := whichGradient.Pattern[nroPattern,stage]^[k];
                ...
                whichGradient.Pattern[nroPattern,stage]^[k] := valeurGradient;
		           end;
           end;
end;
           ...
           begin
            for k := 1 to puiss3[longueurPattern+1] do
              begin
                ...
                if (occ=0) then
                  begin
                    whichOccurences.Pattern[nroPattern,stage]^[k] := 1.0;
                    patternOppose := InverseNoirBlancDansAddressePattern(k,longueurPattern);
                    
                    valeur := whichEval.Pattern[nroPattern,stage]^[k];
                    valeurPatternOppose := whichEval.Pattern[nroPattern,stage]^[patternOppose];
                    
                    if (valeur <> 0.0) & (valeurPatternOppose <> 0.0) 
                      then whichEval.Pattern[nroPattern,stage]^[k] := 0.5*(valeur-valeurPatternOppose);
                      
                    if (valeur=0) & (valeurPatternOppose <> 0.0) 
                      then whichEval.Pattern[nroPattern,stage]^[k] := -valeurPatternOppose;
                    
                    if (valeur <> 0.0) & (valeurPatternOppose=0.0) 
                      then whichEval.Pattern[nroPattern,stage]^[k] := valeur;
                    
                    if (valeur=0.0) & (valeurPatternOppose=0.0) 
                      then whichEval.Pattern[nroPattern,stage]^[k] := 0.0;
                  end;
		           end;
           end;
end;
