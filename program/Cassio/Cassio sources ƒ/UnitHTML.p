...
begin
  for i := 1 to Length(s) do
    begin
      c := s[i];
      case c of
        'Ê' : err := WriteDansZoneMemoire(theZone,'&nbsp;');
        ...
        'Ë' : err := WriteDansZoneMemoire(theZone,'&Agrave;');
        'å' : err := WriteDansZoneMemoire(theZone,'&Acirc;');
        'é' : err := WriteDansZoneMemoire(theZone,'&Egrave;');
        'è' : err := WriteDansZoneMemoire(theZone,'&Euml;');
        'æ' : err := WriteDansZoneMemoire(theZone,'&Ecirc;');
        'ƒ' : err := WriteDansZoneMemoire(theZone,'&Eacute;');
        'ë' : err := WriteDansZoneMemoire(theZone,'&Icirc;');
        ...
        'Ž' : err := WriteDansZoneMemoire(theZone,'&eacute;');
        ...
        'ˆ' : err := WriteDansZoneMemoire(theZone,'&agrave;');
        '‰' : err := WriteDansZoneMemoire(theZone,'&acirc;');
        'Š' : err := WriteDansZoneMemoire(theZone,'&auml;');
        
        '™' : err := WriteDansZoneMemoire(theZone,'&ocirc;');
        '˜' : err := WriteDansZoneMemoire(theZone,'&ograve;');
        'š' : err := WriteDansZoneMemoire(theZone,'&oulm;');
        
        '' : err := WriteDansZoneMemoire(theZone,'&ugrave;');
        'ž' : err := WriteDansZoneMemoire(theZone,'&ucirc;');
        
        '' : err := WriteDansZoneMemoire(theZone,'&ccedil;');
        'Ç' : err := WriteDansZoneMemoire(theZone,'&laquo;');
        'È' : err := WriteDansZoneMemoire(theZone,'&raquo;');
