...
USES UnitOth0,UnitVecteursEval,UnitVecteursEvalInteger;


var verboseMinimisationChi2 : boolean;
    nbPartiesDansOccurences : SInt32;
    occurences : VecteurNouvelleEval;
    vecteurEvaluation : VecteurNouvelleEval;
    vecteurEvaluationInteger : VecteurNouvelleEvalInteger;
    
    memoireAlloueeConjugateGradientChi2 : boolean;
    vecteursConjugateGradientChi2 : 
      record
        g,h,xi : VecteurNouvelleEval;
      end;
    
    memoireAlloueeFonctionLigneChi2 : boolean;
    vecteursFonctionLigneChi2 : 
      record
        P,dir : VecteurNouvelleEval;
      end;
   
    memoireAlloueeTriEvaluation : boolean;
    vecteurTriEval:
      record
        rapportOccurence,rank : VecteurNouvelleEval;
      end;
...
function FichierEvaluationDeCassioTrouvable(nom : str255) : boolean;
...
function NewEval(var position : plateauOthello; var jouable : plBool; var frontiere : InfoFrontRec;nbNoir,nbBlanc,trait : SInt16; var whichEval : VecteurNouvelleEval; var coupsTranquillesNoirs,coupsTranquillesBlancs : ListeDeCases;minimisation : boolean) : TypeReel;
function DeltaPourCettePosition(var position : plateauOthello; var jouable : plBool; var frontiere : InfoFrontRec;nbNoir,nbBlanc,trait : SInt16; var nroRefPartie : SInt32; var ScoreCiblePourNoir,EvalPourNoir : TypeReel; var whichEval : VecteurNouvelleEval) : TypeReel;
function NewEvalEnInteger(var position : plateauOthello; var jouable : plBool; var frontiere : InfoFrontRec;nbNoir,nbBlanc,trait : SInt16; var whichEval : VecteurNouvelleEval; var coupsTranquillesNoirs,coupsTranquillesBlancs : ListeDeCases) : SInt16; 
function NewEvalDeCassio(var position : plateauOthello; var jouable : plBool; var frontiere : InfoFrontRec;nbNoir,nbBlanc,trait : SInt16; var whichEval : VecteurNouvelleEvalInteger; var coupsTranquillesNoirs,coupsTranquillesBlancs : ListeDeCases;alpha,beta : SInt32) : SInt16; 
procedure EcritNewEvalDansRapport(var position : plateauOthello; var jouable : plBool; var frontiere : InfoFrontRec;nbNoir,nbBlanc,trait : SInt16; var whichEval : VecteurNouvelleEval);
procedure EcritNewEvalIntegerDansRapport(var position : plateauOthello; var jouable : plBool; var frontiere : InfoFrontRec;nbNoir,nbBlanc,trait : SInt16; var whichEval : VecteurNouvelleEvalInteger);


procedure IncrementeDeriveesPartiellesCettePosition(deltaEval : TypeReel; var jouable : plBool; var position : plateauOthello; var frontiere : InfoFrontRec;nbNoir,nbBlanc,trait : SInt16; var whichEval : VecteurNouvelleEval);

function InverseNoirBlancDansAddressePattern(pattern,longueur : SInt32) : SInt32; 
procedure CalculeIndexesEdges2X(var plat : plateauOthello; var frontiere : InfoFrontRec; var edge2XNord,Edge2XSud,Edge2XOuest,Edge2XEst : SInt32);
procedure IncrementeEdge2X(var v : VecteurNouvelleEval;whichIndex,whichGameStage : SInt32;incr : TypeReel);
procedure IncrementePattern(var v : VecteurNouvelleEval;whichNroPattern,whichIndex,whichGameStage : SInt32;incr : TypeReel);

procedure WritelnLinePatternAndStringDansRapport(n,length : SInt32;s : str255);
procedure Writeln13SquareCornerAndStringDansRapport(pattern : SInt32;s : str255);
procedure WritelnEdge2XAndStringDansRapport(pattern : SInt32;s : str255);

function ParticipeAuChi2(numeroDansLaListe,numeroRefPartie : SInt32; var tickGroupe : SInt32) : boolean;
procedure CollecteOccurenceCettePosition(var position : plateauOthello; var jouable : plBool; var frontiere : InfoFrontRec;nbNoir,nbBlanc,trait : SInt16; var bidon : SInt32);
procedure CollecteOccurencesPatternDApresListe;

procedure EcritDeltaEvalCettePosition(var position : plateauOthello; var jouable : plBool; var frontiere : InfoFrontRec;nbNoir,nbBlanc,trait : SInt16; var nroRefPartie : SInt32);
...
procedure EcritVecteurMobiliteDansRapport(var whichEval : VecteurNouvelleEval);
procedure TrieEvalEtEcritDansRapport(var whichVecteur : VecteurNouvelleEval);
...
USES UnitListe,UnitAccesStructuresNouvFormat,UnitStrategie,UnitNewGeneral,UnitRapport,SNStrings,
     UnitSymmetricalMapping;
...
procedure WritelnLinePatternAndStringDansRapport(pattern,length : SInt32;s : str255);
...
begin
  ...
  if numeroDuCoup<40 then
    with frontiere do
    begin
      mobiliteNoire   := MobiliteSemiTranquilleAvecCasesC(pionNoir,position,jouable,frontiere,coupsTranquillesNoirs,100000);
			mobiliteBlanche := MobiliteSemiTranquilleAvecCasesC(pionBlanc,position,jouable,frontiere,coupsTranquillesBlancs,100000);
...
var Edge2XNord,Edge2XSud,Edge2XOuest,Edge2XEst : SInt32;
    ...
    evalFrontiereSquares,evalFrontiereDiscs : SInt32;
    diffNbreDiscs : SInt32;
    coupsTranquillesNoirs,coupsTranquillesBlancs : ListeDeCases;
begin 
  trait := pionNoir;
...
begin
  ...
  evalPourNoir := NewEval(position,jouable,frontiere,nbNoir,nbBlanc,trait,whichEval,coupsTranquillesNoirs,coupsTranquillesBlancs,false);
  if nbCoupsJoues<=40
    then
      begin
...
begin
  ...
  EvalEnReel := NewEval(position,jouable,frontiere,nbNoir,nbBlanc,trait,whichEval,coupsTranquillesNoirs,coupsTranquillesBlancs,true);
...
begin
  with statistiques_mobilite do
    begin
      WritelnStringAndNumDansRapport('occ_total = ',total);
      ...
      for k := 0 to 6 do
        ...
        begin
          WritelnStringAndNumDansRapport('stage = ',k);
          for n := -64 to 64 do
            begin
              if stat[k,n].occ <> 0 then
                begin
                  WriteStringAndNumDansRapport('mob = ',n);
                  WriteStringAndNumDansRapport(' : ',stat[k,n].occ);
					      ...
					      if (evalPartielle < alpha)
					        then
					          begin 
					            mobiliteNoire   := MobiliteSemiTranquilleAvecCasesC(pionNoir,position,jouable,frontiere,coupsTranquillesNoirs,100000);
							        evalPartielle   := evalPartielle + coeffMobilite*mobiliteNoire;
							          ...
							          begin 
					                mobiliteBlanche := MobiliteSemiTranquilleAvecCasesC(pionBlanc,position,jouable,frontiere,coupsTranquillesBlancs,mobilitePourCoupure);
					          ...
					          begin 
								      ...
								      if mobilitePourCoupure > 0 then 
							          begin 
							            mobiliteNoire   := MobiliteSemiTranquilleAvecCasesC(pionNoir,position,jouable,frontiere,coupsTranquillesNoirs,mobilitePourCoupure);
							            evalPartielle   := evalPartielle + coeffMobilite*mobiliteNoire;
							          end; 
							      end;
					    end 
...
var Edge2XNord,Edge2XSud,Edge2XOuest,Edge2XEst : SInt32;
    ...
    procedure WritelnStringAndNoteDansRapport(s : str255;note : SInt32);
    begin
...
begin
  ...
  evalPartielle := NewEvalDeCassio(position,jouable,frontiere,nbNoir,nbBlanc,trait,whichEval,
                                   coupsTranquillesNoirs,coupsTranquillesBlancs,-6400,6400);
...
var Edge2XNord,Edge2XSud,Edge2XOuest,Edge2XEst : SInt32;
    ...
    patternsRenverses : array[0..kNbPatternsDansEval] of SInt32;
  ...
  if ok then
   ...
   (* if ((numeroRefPartie mod 100)=0) then
        begin
          ...
          WritelnStringAndNumDansRapport(NumEnString(numeroRefPartie)+' => temps=',tickGroupe);
...
begin
  ...
  tick := TickCount()-tick;
  WritelnStringAndNumDansRapport(' : temps pour la boucle complete =',tick);
end;
...
begin
  if (nbPartiesActives>=1) then
    begin
      ...
      WritelnStringAndNumDansRapport('partie n°',nroRef);
