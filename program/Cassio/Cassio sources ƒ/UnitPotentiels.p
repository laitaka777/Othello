...
type VincenzMoveRec = 
       record
         bestMove : SInt16; 
         bestDefense : SInt16; 
         potentielBestMove : extended;
         sommePotentiels : extended;
       end;
         
const nbDegresMinimisation = 4;

var potentiels : array[0..nbDegresMinimisation,0..99] of extended;
    hits       : array[0..nbDegresMinimisation,0..99] of SInt32;
    
    
procedure InitUnitPotentiels;
procedure SetPotentielsOptimums(var position : PositionEtTraitRec);
...
function EffectueMoveEtCalculePotentielVincenz(var whichPos : PositionEtTraitRec;whichSquare,degreMinimisation : SInt16) : extended;
...
USES UnitStrategie,UnitNormalisation,UnitRapport,UnitScannerOthellistique,UnitMacExtras;
...
var nbPionsRetournes,nbHits,nbVides : SInt32;
    ...
    evalPos,evalOfSquare,coeffMinimisation : extended;
    deltaPotentiel,oldPotentiel : extended;
...
begin
  ...
  if debug then 
    begin
      WritelnDansRapport('');
      WritelnStringAndNumDansRapport('nbUpdatesPotentiels=',nbUpdatesPotentiels);
  ...
  if debug then WritelnStringAndNumDansRapport('nbVides=',nbVides);
	          ...
	          begin
	            ...
	            if debug then 
	              begin
	                ...
	                WritelnStringAndNumDansRapport('  nbPionsRetournes=',nbPionsRetournes);
	            ...
	            for minimisation := 0 to nbDegresMinimisation do
						    begin
						      ...
						      if debug then 
				            WritelnStringAndNumDansRapport('  nbHits = ',nbHits);
...
var nbPionsRetournes,nbVides : SInt16; 
    value,coeffMinimisation : extended;
    mauvaisCoup : boolean;
begin
