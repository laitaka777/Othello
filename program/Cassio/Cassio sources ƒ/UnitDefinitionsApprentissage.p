UNIT UnitDefinitionsApprentissage;
...
USES MacTypes;
 ...
 type CelluleRec=
       record
         ...
         CoupEtCouleurs : byte;               (* Stocke le coup,la couleur de ce coup et le trait resultant *)
         valeurMinimax : byte;                (* appartient à {Gain,Nulle,Perte,PasDansArbre,etc.} *)
         numeroDuCoup : byte;                 (* 1 à 60 *)
         VersionEtProfondeur : byte;          (* version appartient à {kCassio,kYapp,etc.}, profondeur de la recherche heuristique appartient à [0..30] *)
      ...
      CelluleListeHeuristiqueRec=   { Attention : doit avoir la meme taille que CelluleRec car on va faire du transtypage !!! }
       record
         ...
         frere : SInt32;                     (* liste chainee circulaire des freres *)
         memePosition : SInt32;              (* liste chainee circulaire des positions identiques (pour les interversions) *)
         couleur : byte;                      (* Stocke la couleur des propositions heuristiques *)
         valeurMinimax : byte;                (* appartient à {Gain,Nulle,Perte,PasDansArbre,etc.} *)
         numeroDuCoup : byte;                 (* 1 à 60 *)
         VersionEtProfondeur : byte;          (* version appartient à {kCassio,kYapp,etc.}, profondeur de la recherche heuristique appartient à [0..30] *)
