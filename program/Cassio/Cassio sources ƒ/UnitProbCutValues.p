...
USES UnitStatisticalFitting,UnitSetUp,UnitSuperviseur,UnitPhasesPartie,UnitMilieuDePartie;
...
USES UnitListe,UnitAffichageReflexion,UnitMoveRecords,UnitOth2,UnitOth1,UnitRapport,UnitGestionDuTemps;
              ...
              begin
                if positionDansData < ProbCutStat[numeroCoup].nbData then
                  begin
                    ...
                    WritelnStringAndNumDansRapport('positionDansData=',positionDansData);
                  end;
...
procedure DoMidgameForProbCutStats(var position : plateauOthello; var jouable : plBool; var frontiere : InfoFrontRec;nbNoir,nbBlanc,trait : SInt16; var profondeurMilieuDemandee : SInt32);
...
function LitVecteursStatProbCutSurLeDisque(nomFichier : str255) : OSErr;
...
function EcritVecteursStatProbCutSurDisque(nomFichier : str255;vRefNum : SInt16) : OSErr;
var fichierProbCut : FichierTEXT;
    err : OSErr;
begin
  ...
  SetFileCreatorFichierTexte(fichierProbCut,'SNX4');
  SetFileTypeFichierTexte(fichierProbCut,'EVAL');
