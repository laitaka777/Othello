...
USES Timer,MacTypes,UnitUtilitaires,SNStrings,UnitRapport;
      ...
      *)
      ...
      if (stables_hi<>0) then
        begin
		  ...
		  WritelnStringAndNumDansRapport('n1 = ',n1);
		  WritelnStringAndNumDansRapport('n2 = ',n2);
		  WritelnStringAndNumDansRapport('nbre stables = ',n1+n2);
		  WritelnDansRapport('');
		  AttendFrappeClavier;
		  *)
...
begin
  ...
  WritelnStringAndNumDansRapport('stables = ',n);
  WritelnDansRapport('');
end;
