...
USES UnitBigVectorsInteger,UnitVecteursEval;


type VecteurNouvelleEvalInteger =
       record
         Edges2X : array[0..kNbMaxGameStage] of PointMultidimensionnelInteger;
         Pattern : array[0..kNbPatternsDansEval,0..kNbMaxGameStage] of PointMultidimensionnelInteger;
...
procedure AlloueVecteurEvalInteger(var vecteur : VecteurNouvelleEvalInteger);
procedure DisposeVecteurEvalInteger(var vecteur : VecteurNouvelleEvalInteger);

function VecteurEvalIntegerEstVide(var vecteur : VecteurNouvelleEvalInteger) : boolean;
procedure AnnihileVecteurEvalInteger(var vecteur : VecteurNouvelleEvalInteger);
procedure CopierPointeursVecteursEvalInteger(var source,dest : VecteurNouvelleEvalInteger);
procedure AnnuleVecteurEvalInteger(var vecteur : VecteurNouvelleEvalInteger);



function EcritEvalIntegerDansFichierTexte(var fic : FichierTEXT; var v : VecteurNouvelleEvalInteger) : OSErr;
function LitEvalIntegerDansFichierTexte(var fic : FichierTEXT; var v : VecteurNouvelleEvalInteger) : OSErr;
function EcritVecteurEvaluationIntegerSurLeDisque(nomFichier : str255;vRefNum : SInt16; var whichEval : VecteurNouvelleEvalInteger) : OSErr;
function LitVecteurEvaluationIntegerSurLeDisque(nomFichier : str255; var whichEval : VecteurNouvelleEvalInteger) : OSErr;



procedure VecteurEvalToVecteurEvalInteger(var source : VecteurNouvelleEval; var dest : VecteurNouvelleEvalInteger);
procedure VecteurEvalIntegerToVecteurEval(var source : VecteurNouvelleEvalInteger; var dest : VecteurNouvelleEval);
...
USES UnitTraceLog,UnitRapport,UnitNewGeneral,SNStrings;
...
procedure EcritPatternsAlloues(vecteur : VecteurNouvelleEvalInteger);
var stage,k : SInt32;
    s,s1 : str255;
begin
   ...
   for i := 1 to nbTablesDifferentes do
     with table[i] do
       if sorte=kEdge2X then
         ...
         begin
           if (vecteur.Pattern[nroPattern,stage].data <> NIL) then
             AnnulePointMultidimensionnelInteger(vecteur.Pattern[nroPattern,stage]);
         end;
   ...
   for i := 1 to nbTablesDifferentes do
     with table[i] do
       if sorte=kEdge2X 
         ...
         else HomothetieEtTruncaturePointMultidimensionnel(source.Pattern[nroPattern,stage],100.0,dest.Pattern[nroPattern,stage]);
   ...
   for i := 1 to nbTablesDifferentes do
     with table[i] do
       if sorte=kEdge2X 
         ...
         else HomothetieEtPassageEnFloatPointMultidimensionnel(source.Pattern[nroPattern,stage],0.01,dest.Pattern[nroPattern,stage]);
