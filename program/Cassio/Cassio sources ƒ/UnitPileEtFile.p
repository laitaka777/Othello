...
USES SNStrings,UnitServicesMemoire,UnitRapport;
...
begin
  with whichPile do
    begin
      WriteStringAndNumDansRapport('queue=',queue);
      WriteStringAndNumDansRapport('  tete=',tete);
      WriteStringAndNumDansRapport('  pile[queue]=',GetElementDeQueue(whichPile));
      WritelnStringAndNumDansRapport('  pile[tete]=',GetElementDeTete(whichPile));
    end;
end;
